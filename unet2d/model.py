...
from unet2d.buildingblocks import Encoder, Decoder, DoubleConv
from unet2d.utils import create_feature_maps
...
class UNet2D(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, f_maps=64, layer_order='crg', num_groups=8,
        ...
        if isinstance(f_maps, int):
            # use 5 levels in the encoder path as suggested in the UNet paper
...
def get_model(config):
    def _model_class(class_name):
        m = importlib.import_module('unet2d.model')
