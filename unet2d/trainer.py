...
class UNet2DTrainer:
    ...
    Args:
        model (Unet2D): UNet 2D model to be trained
    ...
    def __init__(self, model, optimizer, lr_scheduler, loss_criterion,
                 ...
                 logger=None):
        if logger is None:
            self.logger = utils.get_logger('UNet2DTrainer', level=logging.DEBUG)
        else:
            self.logger = logger
